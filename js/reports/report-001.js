// report-001.js
// Week 1 Report - Identifying Persons and Locations with LLMs
...
<h3>Identifying locations</h3>

<p>In parallel with person identification, we extract geographic locations
mentioned in the text. The system captures both the location as it appears
in the text and a standardised form following Getty TGN conventions.</p>

<p>For each location, we record the immediate textual context (one sentence
before, the sentence containing the location, and one sentence after) to
preserve the semantic meaning of why that place is mentioned.</p>

<p>This allows researchers to understand not just which places are discussed,
but how they relate to the journal's content about electrical technology,
women's roles, and industry development in the 1920s.</p>
`
};
